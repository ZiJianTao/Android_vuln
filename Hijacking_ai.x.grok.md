# Android Manifest Misconfiguration Leading to Task Hijacking in Grok app(ai.x.grok) 
...
![caller.id.phone.number.block](./video/ai.x.grok.gif)
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <application
        ...
        android:taskAffinity="ai.x.grok">
